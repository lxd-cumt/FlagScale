...
from flagscale.train.models.qwen2_5_vl.vit_model import PatchEmbed
from flagscale.train.models.qwen3_vl.vision_transformer_block import VisionTransformerBlock
